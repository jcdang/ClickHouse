...
public:
    ...
    {
        return const_cast<Self &>(*this).dispatch(NoopKeyPtr(x),
...
public:
    ...
    decltype(auto) ALWAYS_INLINE dispatch(KeyPtr && key_ptr, Func && func)
    {
        ...
        {
            case 0:
                return func(impls[0].m0, NoopKeyPtr(key0), 0);
            CASE_1_8 : {
                // first half page
                ...
                return func(impls[buck].m1, NoopKeyPtr(k8), res);
            }
            CASE_9_16 : {
                memcpy(&n[0], p, 8);
                res = _mm_crc32_u64(res, n[0]);
                ...
                buck = getBucketFromHash(res);
                return func(impls[buck].m2, NoopKeyPtr(k16), res);
            }
            CASE_17_24 : {
                memcpy(&n[0], p, 16);
                res = _mm_crc32_u64(res, n[0]);
                ...
                buck = getBucketFromHash(res);
                return func(impls[buck].m3, NoopKeyPtr(k24), res);
            }
            default: {
                memcpy(&n, x.data, 24);
                res = _mm_crc32_u64(res, n[0]);
                ...
                res = _mm_crc32_u64(res, n[0]);
                buck = getBucketFromHash(res);
                return func(impls[buck].ms, key_ptr, res);
            }
        }
    }
    ...
    {
        dispatch(key_ptr, typename Impl::EmplaceCallable{it, inserted});
    }

    MappedPtr ALWAYS_INLINE find(Key x)
    {
        return dispatch(NoopKeyPtr(x), typename Impl::FindCallable{});
    }
